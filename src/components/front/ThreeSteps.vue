  ...
  <div class="container py-[72px] lg:py-[120px] lg:text-center">
    ...
    <div class="mt-12 flex gap-14 max-lg:flex-col lg:mt-[96px] lg:gap-10">
      <div class="flex flex-1 flex-col gap-4 max-lg:flex-col-reverse lg:gap-6">
        <img
          src="/data/assets/images/steps/step1.webp"
          alt=""
          loading="lazy"
      ...
      <div class="flex flex-1 flex-col gap-4 max-lg:flex-col-reverse lg:gap-6">
        <img
          src="/data/assets/images/steps/step2.webp"
          alt=""
          loading="lazy"
          class="mx-auto w-full max-w-[320px]"
        />
      ...
      <div class="flex flex-1 flex-col gap-4 max-lg:flex-col-reverse lg:gap-6">
        <img
          src="/data/assets/images/steps/step3.webp"
          alt=""
          loading="lazy"
          class="mx-auto w-full max-w-[320px]"
        />
    ...
    <Btn
      classes="lg:mx-auto lg:min-w-[255px] mt-12 lg:w-fit"
      external
      to="/onboarding-app"
    >
      {{ $t('try_it_now') }}
